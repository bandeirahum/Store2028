...
// Configuration
//----------------------------------------------------------------------------------------------------
  this.width = 110;                     // width (pixels)
  this.bgColor = "#e9e9e9";             // background color
  this.textFont = "tahoma";      // text font family
  this.textSize = 13;                   // text font size (pixels)
  this.textColor = "#757575";           // text color
  this.border = "1px solid #9a9a9a";   // border (CSS spec: size style color, e.g. "1px solid #D00000")
  this.opacity = 100;                    // opacity (0 - 100); not supported by all browsers
  this.cursorDistance = 13;              // distance from mouse cursor (pixels)
