$(document).ready(function() {
	...
	function previewKit($) {
		...
		if(base == "b02" && cor == "cerejeira"){
			$(".imgBase").attr("src","https://www.rumo.com.br/lojas/00002028/prod/bases2015/macica/bmm2cerejeira.jpg");
		
		}
		else if(base == "b02" && cor == "jacaranda"){
			$(".imgBase").attr("src","https://www.rumo.com.br/lojas/00002028/prod/bases2015/macica/bmm2jacaranda.jpg");
			
		}
		else if(base == "b02" && cor == "mogno"){
			$(".imgBase").attr("src","https://www.rumo.com.br/lojas/00002028/prod/bases2015/macica/bmm2mogno.jpg");
			
		}
		else if(base == "b03" && cor == "cerejeira"){
			$(".imgBase").attr("src", "https://www.rumo.com.br/lojas/00002028/prod/bases2015/macica/bmm3cerejeira.jpg");
			
		}
		else if(base == "b03" && cor == "jacaranda"){
			$(".imgBase").attr("src", "https://www.rumo.com.br/lojas/00002028/prod/bases2015/macica/bmm3jacaranda.jpg");
			
		}
		else if(base == "b03" && cor == "mogno"){
			$(".imgBase").attr("src","https://www.rumo.com.br/lojas/00002028/prod/bases2015/macica/bmm3mogno.jpg");
			
		}
		else if(base == "b04" && cor == "cerejeira"){
			$(".imgBase").attr("src", "https://www.rumo.com.br/lojas/00002028/prod/bases2015/macica/bmm4cerejeira.jpg");
			
		}
		else if(base == "b04" && cor == "jacaranda"){
			$(".imgBase").attr("src", "https://www.rumo.com.br/lojas/00002028/prod/bases2015/macica/bmm4jacaranda.jpg");
			
		}
		else if(base == "b04" && cor == "mogno"){
			$(".imgBase").attr("src", "https://www.rumo.com.br/lojas/00002028/prod/bases2015/macica/bmm4mogno.jpg");
		
		}
		else if(base == "b05" && cor == "cerejeira"){
			$(".imgBase").attr("src", "https://www.rumo.com.br/lojas/00002028/prod/bases2015/macica/bmm5cerejeira.jpg");
			
		}
		else if(base == "b05" && cor == "jacaranda"){
			$(".imgBase").attr("src", "https://www.rumo.com.br/lojas/00002028/prod/bases2015/macica/bmm5jacaranda.jpg");
			
		}
		else if(base == "b05" && cor == "mogno"){
			$(".imgBase").attr("src", "https://www.rumo.com.br/lojas/00002028/prod/bases2015/macica/bmm5mogno.jpg");
			
		}
		else if(base == "b06" && cor == "cerejeira"){
			$(".imgBase").attr("src", "https://www.rumo.com.br/lojas/00002028/prod/bases2015/macica/bmm6cerejeira.jpg");
			
		}
		else if(base == "b06" && cor == "jacaranda"){
			$(".imgBase").attr("src", "https://www.rumo.com.br/lojas/00002028/prod/bases2015/macica/bmm6jacaranda.jpg");
			
		}
		else if(base == "b06" && cor == "mogno"){
			$(".imgBase").attr("src", "https://www.rumo.com.br/lojas/00002028/prod/bases2015/macica/bmm6mogno.jpg");
