$(document).ready(function() {
	...
	$("#cor01").click(function() {
		$("#checkCor").css("display", "block").css("top", "60px").css("left", "70px");
		cor = "cerejeira";
		if(redT2 == true){
	...
	$("#cor02").click(function() {
		$("#checkCor").css("display", "block").css("top", "60px").css("left", "192px");
		cor = "imbuia";
		if(redT2 == true){
			$("#tit2").removeAttr("style");
		}
	...
	$("#cor03").click(function() {
		$("#checkCor").css("display", "block").css("top", "60px").css("left", "305px");
		cor = "jacaranda";
		if(redT2 == true){
			$("#tit2").removeAttr("style");
		}
